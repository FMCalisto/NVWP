...
if (!defined('CDAP_VERSION')) {
    define('CDAP_VERSION', '1.0.2'); // plugin version information
}
...
if (!class_exists('Comments_Disable_AP')) {
    ...
    class Comments_Disable_AP {
        ...
        function plugin_option_page() {
            add_options_page(__('Comments Disable', CDAP_TD), __('Comments Disable', CDAP_TD), 'manage_options', 'comments-disable-ap', array($this, 'plugin_settings'));
        }
        ...
        function plugin_settings_link($links) { 
          $settings_link = '<a href="options-general.php?page=comments-disable-ap">Settings</a>'; 
