...
class News_Manager_Archive_Widget extends WP_Widget
{
	...
	{
		parent::__construct(
			'News_Manager_Archive_Widget',
			__('News Archives', 'news-manager'),
			array(
...
class News_Manager_Calendar_Widget extends WP_Widget
{
	...
	{
		parent::__construct(
			'News_Manager_Calendar_Widget',
			__('News Calendar', 'news-manager'),
			array(
	...
	public function widget($args, $instance)
	{
		...
		if(++$this->nm_included_widgets === 1)
		{
			wp_register_script(
				...
				NEWS_MANAGER_URL.'/js/front-widgets.js',
				array('jquery')
			);
...
class News_Manager_List_Widget extends WP_Widget
{
	...
	{
		parent::__construct(
			'News_Manager_List_Widget',
			__('News List', 'news-manager'),
			array(
...
class News_Manager_Categories_Widget extends WP_Widget
{
	...
	{
		parent::__construct(
			'News_Manager_Categories_Widget',
