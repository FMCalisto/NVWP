...
function personById($idDBLink, $id) {
  ...
  $result = odbc_exec($idDBLink, "SELECT pessoaId,nome,numero,ligacao,telefone,email,sala,url,habilitacao,categoria,ListaFct,foto,admissao,dataInactivacao FROM PessoalInesc where numero=\"" . trim($id) . "\"");
  /*
  DAVID: FIXME
