...
* iPhone 6 & 6 plus issue solved

* category title issue solved 

= 2.4 to 2.5 =
 
* Add one more service block style 

= 2.5 to 2.6 =

* solve javascript error 

= 2.8 to 2.9 =

* deprecated since version 4.3.0! error solve . it is urgent update 
= 2.9 to 3.0 =
